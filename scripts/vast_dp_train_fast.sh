...
# loss, EMA and LR schedule are unchanged; see docs/DP_TRAINING_THROUGHPUT.md
# for the measured per-change breakdown and the batch/LR pairs.
#
...
# the run was equivalent; see docs/DP_TRAINING_THROUGHPUT.md.
#
