...
calibration sits 9.13 mm and 1.76 deg from the authored pose (see
``docs/EPISODE_RERENDER.md``), which the current +-5 mm / +-1 deg box does not
contain: data generated under it never sees the real camera pose. Widening the
box needs an upper bound, and there are two independent ones.
