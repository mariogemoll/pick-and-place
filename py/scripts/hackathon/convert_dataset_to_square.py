...
angle ``SimCameraRig`` feeds MuJoCo. State, action, task and timing are copied
through unchanged.
...
Example:
    ...
    cd py
    python scripts/pick_and_place/convert_dataset_to_square.py \
        --src /path/to/pick-and-place-private-2 \
        --dst /path/to/pick-and-place-private-2-512
"""
