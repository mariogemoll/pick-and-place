...
def _result(scenario_id: str, success: bool, group: str = "canonical") -> EpisodeResult:
    return EpisodeResult(
        ...
        initial_tcp_to_cube_distance_m=0.20,
        min_tcp_to_cube_distance_m=0.05 if success else 0.15,
        tcp_to_cube_distance_reduction_m=0.15 if success else 0.05,
        time_to_min_tcp_to_cube_distance_s=1.0,
        control_steps=100,
