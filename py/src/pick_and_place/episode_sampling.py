...
episode begins. Sampling only — :mod:`pick_and_place.episodes` takes a draw from
here and vets it against live physics, and
:mod:`pick_and_place.scenario_sampling` composes the cube and target draws into
