...
def draw_overhead_camera_jitter(
    ...
    *,
    ...
    Shared by :class:`~pick_and_place.sim.domain_randomization.DomainRandomizationPreset`
    ...
    generating ones it cannot; see :mod:`pick_and_place.sim.camera_pose_envelope`.
    """
