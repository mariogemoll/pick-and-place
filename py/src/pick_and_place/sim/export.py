...
Usage::
    ...
    python -m pick_and_place.sim.export [-o OUTPUT]
"""
...
from pick_and_place.core.camera_calibration import load_camera_intrinsics, load_local_camera_intrinsics
...
from pick_and_place.sim.materials import MaterialConfig
from pick_and_place.sim.scene import ROBOT_BASE_Z_OFFSET, build_environment, build_scene
...
def main() -> None:
    ...
    if output is None:
        ...
        output = Path(__file__).resolve().parents[3] / "out" / name
