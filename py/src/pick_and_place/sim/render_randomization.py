...
Both draws reuse a :class:`~pick_and_place.sim.domain_randomization.DomainRandomizationPreset`
for its scalars, so the envelope is described in exactly one place, and both are
seeded per episode through :func:`~pick_and_place.sim.domain_randomization.domain_seed`,
