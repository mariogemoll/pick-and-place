...
The flags and what they mean live with the config, in
``pick_and_place.cli.train_flow_image_policy_parser``; this is the training loop.
"""
...
from pick_and_place.cli.train_flow_image_policy_parser import parse_arguments
