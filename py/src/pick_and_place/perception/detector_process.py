...
def _detector_main(conn, quad_decimate: float, nthreads: int) -> None:
    ...
    from pick_and_place.perception.cube_detection import make_cube_detector
...
class DetectorProcess:
    ...
    it, so it drops into a :class:`~pick_and_place.perception.cube_detection.CubeTracker`
