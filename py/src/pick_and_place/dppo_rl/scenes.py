...
"""Training resets for DPPO, drawn from the evaluation distribution.

The plan's rule is that DPPO never trains on the frozen benchmark scenes. Both
sides draw from :mod:`pick_and_place.scenario_sampling`, so the distribution is
shared by construction, but the seed streams are disjoint: manifests use small
bases (1701 for ``canonical_100_v1``/``dr_100_v1``, 2701 for the perturbation
